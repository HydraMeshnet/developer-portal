...
6. The user notices that a nearby swimming pool gives a 20% discount for citizens resident in its district.
   1. The user also notices that the swimming pool supports IOP SSI and has a service endpoint to prove district of residence based on digitalized ID cards.
